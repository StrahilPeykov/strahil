...
import { Brain, Heart, Lightbulb, BookOpen, Wrench, Coffee, Grid3x3, List, Search } from 'lucide-react'
...
export function NotesPageClient({ initialNotes }: NotesPageClientProps) {
  ...
  const filteredNotes = useMemo(() => {
    return initialNotes.filter((idea) => {
  ...
  }, [selectedCategory, searchQuery, initialNotes])
