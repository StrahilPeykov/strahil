...
import { PenTool, Search, Clock, ArrowRight } from 'lucide-react'
...
interface BlogPageClientProps {
  initialArticles: ContentListItem[]
}
...
export function BlogPageClient({ initialArticles }: BlogPageClientProps) {
  const [searchQuery, setSearchQuery] = useState('')
  const [selectedCategory, setSelectedCategory] = useState('All')

  const categories = useMemo(() => {
    const cats = new Set(['All'])
    initialArticles.forEach((article) => cats.add(article.category))
