...
import { ArrowLeft, Brain, AlertTriangle, Users, Target, Shield, Lightbulb, TrendingUp } from 'lucide-react'
import Link from 'next/link'
import { PageWrapper } from '../../../components/layout/PageWrapper'
import { Badge } from '../../../components/ui/Badge'

export default function HumansNotTruthSeekingPage() {
  return (
    <PageWrapper>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                <Badge variant="blue">Theory of Mind</Badge>
                <Badge variant="purple">Psychology</Badge>
                <Badge variant="pink">Philosophy</Badge>
              </div>
              
              <h1 className="text-4xl lg:text-6xl font-display font-bold text-white mb-6">
                Humans are not
                <span className="text-transparent bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text"> Truth-Seeking Machines</span>
              </h1>
              
              <p className="text-xl text-gray-400 mb-8">
                Why our brains are optimized for survival and social cohesion, not objective truth. 
                Understanding the evolutionary basis of our cognitive biases.
              </p>
              
              <div className="flex items-center gap-6 text-sm text-gray-500">
                <span>Theory of Mind Series</span>
                <span>•</span>
              ...
              >
                ...
                <div className="mt-12 p-6 bg-slate-900/30 rounded-xl border border-slate-800">
                  ...
                  <ul className="space-y-2">
                    <li>
                      <Link href="/ideas/constellation-of-beliefs" className="text-blue-400 hover:text-blue-300">
                        → The Constellation of Beliefs
                      </Link>
                    </li>
                    <li>
                      <Link href="/ideas/social-incentives-beliefs" className="text-blue-400 hover:text-blue-300">
                        → Social Incentives Dictate Beliefs
                      </Link>
                    </li>
                    <li>
                      <Link href="/ideas/aesthetic-vs-function" className="text-blue-400 hover:text-blue-300">
